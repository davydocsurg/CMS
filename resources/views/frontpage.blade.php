            ...
            <div class="container">
                <div class="banner_content d-md-flex justify-content-between align-items-center">
                    <div class="mb-3 mb-md-0">
                        ...
                        <p>Welcome to my <i class="fas fa-blog" style="color: #71cd14"></i><sup>{{ $title }}</sup>
                        </p>
                    </div>
                    <div class="page_link">
                                ...
                                <div class="blog_details">
                                    ...
                                    <ul class="blog-info-link">
                                        <li class="card-body shadow-lg"><a href="#!">
                                                ...
                                                <img src="{{ $post->user->profile->avatar }}" height="" alt=""
                            ...
                            <div class="card">
                                <div class="card-body overflow-hidden p-lg-6">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-lg-6"><img class="img-fluid" src="{{ asset('images/4.png') }}"
                                                alt="">
                                        </div>
