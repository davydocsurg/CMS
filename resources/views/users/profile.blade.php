        ...
        <div class="col-lg-12">
          ...
          <div class="float-right justify-content-space-between">
            @if ($user->profile->facebook)
              <a href="{{ $user->profile->facebook }}" target="_blank" rel="noopener noreferrer" class="text-primary"><i class="fab fa-facebook text-white"></i></a>
            @endif

            @if ($user->profile->twitter)
              <a href="{{ $user->profile->twitter }}" target="_blank" rel="noopener noreferrer" class="text-info"><i class="fab fa-twitter"></i></a>
            @endif

            @if ($user->profile->youtube)
              <a href="{{ $user->profile->youtube }}" target="_blank" rel="noopener noreferrer" class="text-danger"><i class="fab fa-youtube"></i></a>
            @endif

            @if ($user->profile->linkedin)
              <a href="{{ $user->profile->linkedin }}" target="_blank" rel="noopener noreferrer" class="text-info"><i class="fab fa-linkedin"></i></a>
            @endif
          </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('profile.update', auth()->user()->profile->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                              {{-- <div class="form-group">
                                <img src="{{ asset(auth()->user()->profile->avatar) }}" alt="" class="rounded-circle" style="width:50%;">
                              </div> --}}
                              <div class="form-group">
                            ...
                            <div class="col-12">
                              <div class="form-group"><label for="email">Change Email</label>
                                <input class="form-control" id="email" type="email" name="email" value="{{ auth()->user()->email }}"></div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <label for="password" class="">{{ __('New Password') }}</label>
                                    ...
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" placeholder="minimum of 8 characters">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="about" name="about" cols="5" rows="5" placeholder="About You">{{ $user->profile->about }}</textarea></div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="job_title" id="job_title" class="form-control" value="{{ $user->profile->job_title }}" placeholder="Senior Software Engineer at Technext Limited">
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="location" id="location" class="form-control" value="{{ $user->profile->location }}" placeholder="New York, USA">
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <input type="url" name="facebook" id="facebook" class="form-control" value="{{ $user->profile->facebook }}" placeholder="https://facebook.com/username">
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <input type="url" name="youtube" id="youtube" class="form-control" value="{{ $user->profile->youtube }}" placeholder="https://youtube.com/channel">
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <input type="url" name="twitter" id="twitter" class="form-control" value="{{ $user->profile->twitter }}" placeholder="https://twiiter.com/username">
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <input type="url" name="linkedin" id="linkedin" class="form-control" value="{{ $user->profile->linkedin }}" placeholder="https://linkedin.com/in/username">
                              </div>
                            </div>
