...
<div class="col-md-12">
  <div class="card mb-3 bg-dark text-white">
    <div class="card-header position-relative min-vh-25 mb-7">
      ...
      <div class="bg-holder rounded-soft rounded-bottom-0" style="background-image: url({{ asset($user->profile->avatar) }});"></div>
      <!--/.bg-holder-->
      <div class="avatar avatar-5xl avatar-profile"><img class="rounded-circle img-thumbnail shadow-sm" src="{{ asset($user->profile->avatar) }}" alt="" width="200"></div>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                              <div class="form-group"><label for="email">Change Email</label>
                                <input class="form-control" id="email" type="email" name="email" value="{{ $user->email }}"></div>
                            </div>
